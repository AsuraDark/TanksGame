...
namespace TanksGame.Tanks
{
    internal class TanksGameLogic : BaseGameLogic, IArrowListener
    {
        ...
        public TanksGameLogic(UnitSystem gameUnitSystem, LevelSystem levelSystem, GameMap gameMap)
        {
            _levelSystem = levelSystem;
            _gameMap = gameMap;
            _gameplayState = new TanksGameplayState(gameUnitSystem, _levelSystem, _gameMap);
        }
        ...
        private void GoToGameOver()
        {
            ...
            _showTextState.text = "ИГРА ОКОНЧЕНА";
            ChangeState(_showTextState);
        }
        private void GoToNextLevel()
        {
            _newGamePending = false;
            _showTextState.text = $"Уровень {_currentLevel}";
            ChangeState(_showTextState);
        }
